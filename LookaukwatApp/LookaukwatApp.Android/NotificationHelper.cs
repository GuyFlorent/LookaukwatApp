        ...
        public class NotificationHelper : INotification
        {
            ...
            public void CreateNotification(String title, String message)
            {
                try
                {
                    ...
                    mBuilder.SetSmallIcon(Resource.Drawable.ico);
                    mBuilder.SetWhen(Java.Lang.JavaSystem.CurrentTimeMillis());
                    mBuilder.SetContentTitle(title)
                            ...
                            .SetLargeIcon(BitmapFactory.DecodeResource(Android.App.Application.Context.Resources, Resource.Drawable.ico))
