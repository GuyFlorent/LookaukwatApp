...
{
    public class StaticListVehiculeViewModel
    {
        public static List<string> GetRubriqueVehiculeList = new List<string>
        {
           "Voitures",
"Location voitures",
"Motos",
...
"Equipement Moto"
        ...
        public static List<string> GetBrandVehiculeAutoList = new List<string>
        {
            "Toyota",
"Mercedes",
"Hyundrai",
...
"Autre"
        ...
        public static List<string> GetModelVehiculeAutoToyotaList = new List<string>
        {
            "4-runner",
"Avensis",
"Aygo",
...
"Autre"
        ...
        public static List<string> GetModelVehiculeAutoHyundaiList = new List<string>
        {
            "Accent",
"Atos",
"Azera",
...
"Autre"
        ...
        public static List<string> GetModelVehiculeAutoMercedesList = new List<string>
        {
            "190-series",
"200",
"220",
...
"Autre"
        ...
        public static List<string> GetModelVehiculeAutoMazdaList = new List<string>
        {
            "121",
"2",
"3",
...
"Autre"
        ...
        public static List<string> GetModelVehiculeAutoKiaList = new List<string>
        {
            "Carnival",
"Cee D",
"Cerato",
...
"Autre"
        ...
        public static List<string> GetBrandVehiculeMotoList = new List<string>
        {
            "Barjac",
"Bli",
"Kawasaki",
...
"Autre"
        ...
        public static List<string> GetTypeVehiculeAutoList = new List<string>
        {
            "4×4,Suv",
"Berline",
"Break",
...
"Autre"
        ...
        public static List<string> GetPetrolVehiculeList = new List<string>
        {
            "Essence",
"Diesel",
"Hybride",
...
"Autre"
        ...
        public static List<string> GetNumberOfDoorVehiculeList = new List<string>
        {
            "2",
"3",
"4",
...
"Autre"
        ...
        public static List<string> GetColorVehiculeList = new List<string>
        {
            "Argent",
"Beige",
"Blanc",
...
"Autre"
        ...
        public static List<string> GetGearBoxVehiculeList = new List<string>
        {
            "Manuelle",
            "Automatique"
        };
        public static List<string> GetStateVehiculeList = new List<string>
        {
            "Neuf",
            "Occasion"
